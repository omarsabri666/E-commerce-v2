import{a as i,j as a,u as o,s as n}from"./index-ba286fc0.js";function c({link:e,id2:s}){const t=i();return a.jsx("div",{onClick:()=>t(`/categoryDetails/${e._id}`),className:` flex  justify-center items-center  rounded-lg py-2 cursor-pointer hover:text-omar text-lg transition-all text-center
